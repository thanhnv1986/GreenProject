 ...
 */
_module.forgot = function (req, res, next) {
    async.waterfall([
        ...
        function (token, user, done) {
            _module.render(req, res, 'email-templates/reset-password-email', {
 ...
 */
_module.validateResetToken = function (req, res, next) {
 ...
 * @param res
 */
_module.invalidToken = function (req, res) {
    _module.render(req, res, 'reset-password', {
 ...
 * @param res
 */
_module.resetForm = function (req, res) {
    _module.render(req, res, 'reset-password', {
        form: true
    });
};
 ...
 */
_module.reset = function (req, res, next) {
    // Init Variables
    var time = Date.now();
    ...
    async.waterfall([
        ...
        function (user, done) {
            _module.render(req, res, 'email-templates/reset-password-confirm-email', {
                name: user.display_name,
                appName: config.app.title,
